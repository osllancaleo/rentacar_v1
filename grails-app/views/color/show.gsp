		...
		<div id="show-color" class="content scaffold-show" role="main">
			...
			<ol class="property-list color">
				...
				<li class="fieldcontain">
					<span id="nombre-label" class="property-label"><g:message code="color.nombre.label" default="Nombre" /></span>
					
						<span class="property-value" aria-labelledby="nombre-label"><g:fieldValue bean="${colorInstance}" field="nombre"/></span>
